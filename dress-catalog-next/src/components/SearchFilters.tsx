          ...
          <div className="absolute left-0 right-0 top-full z-50 mt-2 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
            {suggestionsLoading ? (
              ...
              <div className="max-h-80 overflow-y-auto py-2">
                <p className="px-4 pb-2 pt-1 text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">
                  Possible matches
                </p>
              ...
              <div className="px-4 py-4">
                ...
                <button
                  ...
                  className="mt-1 text-xs font-bold text-pink-600 hover:text-pink-700"
                >
                  Search for “{searchText.trim()}” anyway
                </button>
              </div>
            )}
          </div>
